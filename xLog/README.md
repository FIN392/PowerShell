...
[How to initialize a log?](#How-to-initialize-a-log)
[How to add an entry to a log?](#How-to-add-an-entry-to-a-log)
[How the log files looks like?](#How-the-log-files-looks-like)
